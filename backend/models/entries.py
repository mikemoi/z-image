...
from classification_schema import SUB_TOPICS_BY_TOPIC, validate_topic_tree_values
...
_SUB_TOPICS = tuple(dict.fromkeys(topic for values in SUB_TOPICS_BY_TOPIC.values() for topic in values))
SubTopic = Literal[*_SUB_TOPICS]

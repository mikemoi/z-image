...
- 首页“今日推荐”支持上一张/下一张；“我的 → 集中批阅”每批取 10 条、逐张处理。
- 想法、日志、长期计划和截图原文支持人工重点；AI 分类同次建议最多 3 条，人工结果优先。
...
1. 讨论并修复 OCR/识别后正文排版。
2. 首页信息架构整理，移除已迁到数据概览的统计区域。
3. 新增“记录 → 近日”轻量备忘；长期计划保留在“我的”。
4. 想法簇/可逆合并、截图追问、重新遇见重做。
5. 最后再做向量与语义聚合。
